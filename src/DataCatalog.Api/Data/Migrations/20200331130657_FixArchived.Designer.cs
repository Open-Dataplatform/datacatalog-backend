...
namespace DataCatalog.Api.Data.Migrations
{
    ...
    [Migration("20200331130657_FixArchived")]
    partial class FixArchived
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataCatalog.Api.Data.Model.Source", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5777efb5-f55c-4f16-bb83-0125b810f995"),
            ...
            modelBuilder.Entity("DataCatalog.Api.Data.Model.Dataset", b =>
                {
                    b.HasOne("DataCatalog.Api.Data.Model.Confidentiality", null)
                        .WithMany("Datasets")
                        .HasForeignKey("ConfidentialityId");
                    ...
                    b.HasOne("DataCatalog.Api.Data.Model.Source", "Source")
                        .WithMany("Datasets")
