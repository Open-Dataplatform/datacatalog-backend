...
namespace DataCatalog.Api.Data.Migrations
{
    ...
    [Migration("20200325100303_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataCatalog.Api.Data.Model.Dataset", b =>
                {
                    ...
                    b.Property<int>("StewardId")
                        .HasColumnType("int");

                    b.Property<Guid?>("StewardId1")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DataCatalog.Api.Data.Model.Dataset", b =>
                {
                    b.HasOne("DataCatalog.Api.Data.Model.MemberGroup", "Steward")
                        .WithMany("Datasets")
                        .HasForeignKey("StewardId1");
                });
