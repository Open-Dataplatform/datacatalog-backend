...
namespace DataCatalog.Api.Data.Migrations
{
    ...
    [Migration("20200810123359_AchAccounts")]
    partial class AchAccounts
    {
            ...
            modelBuilder.Entity("DataCatalog.Api.Data.Model.Member", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("a2edfe21-83d9-4fb1-9365-101f4f0d38c3"),
                            Email = "ach-user@energinet.dk",
                            MemberRole = 2,
                            Name = "André Bryde Alnor (bruger)",
                            Password = "ÆNådDoKaGæt"
                        },
                        new
                        {
                            Id = new Guid("905984a3-0e70-4ff5-85be-6325b3d1bab8"),
                            Email = "ach-datasteward@energinet.dk",
                            MemberRole = 1,
                            Name = "André Bryde Alnor (data steward)",
                            Password = "ÆNådDoKaGæt"
                        });
                });
